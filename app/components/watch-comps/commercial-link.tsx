...
const Commercial = () => {
  return (
    <div className='flex w-[55vw] my-20 justify-between'>
      <div>
        <div>
          <Image src='https://www.dailywire.com/images/bentkey/bk-logo-sq.png' alt='bentkey' />
        </div>
      ...
      <div>
        <Image className='w-[20vw]' src='https://www.dailywire.com/images/bentkey/chip-bug-mobile.png' alt='' />
      </div>
    </div>
  );
};
